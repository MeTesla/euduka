...
{
  texte:`Dans un monologue, le condamné pense à l'idée d'écrire son journal intime puisqu'il a le moyen de le faire. Pourquoi ne pas le faire ? L'écriture sera l'expression de sa souffrance  et la délivrance de cette idée de mort qui l'entoure et le possède. D'ailleurs, analyser et décrire sa souffrance est un moyen efficace pour moins souffrir.`,
  listeMots:['monologue', 'journal', 'écriture', 'souffrance', 'possède', 'analyser', 'souffrir']
},
{
  texte:`Le moment où on s'apprête à prononcer la sentence, le condamné avait un grand espoir : on ne peut pas prononcer une condamnation à mort dans un si beau jour. Les juges avaient l'air satisfaits, de la joie peut-être. Les jurés paraissaient blêmes et fatigués.`,
  listeMots: ['sentence', 'espoir', 'condamnation', 'juges', 'blêmes']
},
{
  texte:`Les deux gendarmes m’attendaient au seuil de la cellule. On me remit les menottes. Cela avait une petite serrure compliquée qu’ils fermèrent avec soin. Je laissai faire; c’était une machine sur une machine.`,
  listeMots: ['gendarmes', 'cellule', 'menotte', 'serrure', 'machine']
},
{
  texte:`En moi d'août, il y a déjà trois jours que le procès du condamné a commencé. les spectateurs y assistaient comme des corbeaux autour d'un cadavre. Trois jours que cette fantasamgorie des juges, des témoins des avocats. Durant ces trois jours, le condamné n'arrive pas à dormir, le troisième il dort de fatigue et d'ennui.`,
  listeMots: ['août', 'procès', 'spectateurs', 'cadavre', 'fantasmagorie', 'avocats', 'fatigue']
},
{
  texte:`Dans une cellule de la prison de Bicêtre, un condamné à mort souffre d'une idée qui le hante : "condamné à mort". En effet, il s'agit de sa sentence qu'il a entendu le jour de son procès. Depuis ce jours-là, cette phrase est la seule qui lui reste dans la tête.`,
  listeMots:['cellule', 'prison', 'idée', 'sentence', 'procès'] 
},
{
  texte:`Le condamné reçoit deux visites : celle du prêtre, puis celle de l'huissier. Ce dernier lui annonce que le pourvoi est rejeté, que son exécution aura lieu le jour même et qu’il reviendra le chercher une demi-heure plus tard.`,
  listeMots:['visites', 'prêtre', 'huissier', 'pourvoi ', 'exécution']
},
{
  texte:`Publié en 1829, Le Dernier Jour d’un condamné est un roman à thèse de Victor Hugo. L’auteur lutte contre la peine de mort. Il fait de son roman un véritable réquisitoire politique. Il écrit son œuvre après avoir vu un bourreau préparer la guillotine pour une exécution.`,
  listeMots: ['1829', 'thèse', 'contre' , 'réquisitoire', 'bourreau', 'guillotine'] 
}
]
/*
export const textesVide=[
...
'replace': ['locataires', 'gnawa','six', 'mauvais', 'maure', 'dispute', 'Zoubida', 'Rahma']
},
...
'replace': ['mardi', 'Msid', 'déteste', 'souffrante', 'Boughaleb', 'origine', 'teigneux']
},
...
'replace': ['Msid', 'lentement', 'disparition', 'retrouver', 'remercier', 'mendiants', 'voisines']
},
...
'replace': ['printemps', 'joue', 'malheurs', 'Abdelkader', 'lendemain', 'rapporte', 'Abdellah', 'extraordinaires']
},
...
'replace': ['mercredi', 'Fqih', 'Achoura', 'relate', 'mort', 'Tahar', 'cauchemar']
},
...
'replace': ['préparatifs', 'équipes', 'frotteurs', 'dispute', 'Triste', 'rêveries', 'Khadija']
},
...
'replace': ['accompagne', 'souk', 'jouets', 'soirée', 'musique', 'tôt', 'Msid', 'exceptionnelle']
},
...
'replace': ['Achoura', 'souk', 'bracelets', 'bagarre', 'veut', 'tombe']
},
...
'replace': ['capital', 'bracelets', 'environ', 'souffre', 'départ', 'drame', 'visite', 'voyant', 'Arafi']
},
...
'replace': ['consultent', 'rassurer', 'secret', 'garder', 'saint', 'solitude', 'reçoit', 'mari']
},
...
'replace': ['discutent', 'Salama', 'mariage', 'coiffeur', 'couple', 'divorce']
},
...
'replace': ['retour', 'événements', 'félicite', 'discussion', 'hommes', 'solitaire', 'rêveur', 'merveilles']
},
