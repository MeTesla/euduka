...
'listeMots': ['merveilles','autobiographique', 'Ahmed', 'six', 'Mohammed', 'boîte']
},
...
'listeMots': ['locataires', 'gnawa','six', 'mauvais', 'maure', 'dispute', 'Zoubida', 'Rahma']
},
...
'listeMots': ['mardi', 'Msid', 'déteste', 'souffrante', 'Boughaleb', 'origine', 'teigneux']
},
...
'listeMots': ['Msid', 'lentement', 'disparition', 'retrouver', 'remercier', 'mendiants', 'voisines']
},
...
'listeMots': ['printemps', 'joue', 'malheurs', 'Abdelkader', 'lendemain', 'rapporte', 'Abdellah', 'extraordinaires']
},
...
'listeMots': ['mercredi', 'Fqih', 'Achoura', 'relate', 'mort', 'Tahar', 'cauchemar']
},
...
'listeMots': ['préparatifs', 'équipes', 'frotteurs', 'dispute', 'Triste', 'rêveries', 'Khadija']
},
...
'listeMots': ['accompagne', 'souk', 'jouets', 'soirée', 'musique', 'tôt', 'Msid', 'exceptionnelle']
},
...
'listeMots': ['Achoura', 'souk', 'bracelets', 'bagarre', 'veut', 'tombe']
},
...
'listeMots': ['capital', 'bracelets', 'environ', 'souffre', 'départ', 'drame', 'visite', 'voyant', 'Arafi']
},
...
'listeMots': ['consultent', 'rassurer', 'secret', 'garder', 'saint', 'solitude', 'reçoit', 'mari']
},
...
'listeMots': ['discutent', 'Salama', 'mariage', 'coiffeur', 'couple', 'divorce']
},
...
'listeMots': ['retour', 'événements', 'félicite', 'discussion', 'hommes', 'solitaire', 'rêveur', 'merveilles']
}
]