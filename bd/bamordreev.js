module.exports = { ordreEventsData };
const ordreEventsData = [
  ...
  `Au sanctuaire de Sidi Ali Boughaleb, le narrateur se fait griffer par un chat`,
  /* `Sidi Mohamed tombe maladie`,*/
